...
Developed a fully responsive profile page with React.js and TailwindCSS with Demo data made available on local JSON file 'Data/content.json' It has following components as below:  
