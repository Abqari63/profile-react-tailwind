            ...
            <div className="profile-description flex flex-col justify-start items-start md:justify-center md:items-center gap-5 sm:gap-8 md:gap-10 px-2 sm:px-4 md:px-14">
                    ...
                    <div className="profile-name py-2 mx-0 sm:mx-1 md:mx-2 flex flex-col gap-3 justify-start items-between">
                        ...
                        <div className="follow-details flex gap-4 font-bold text-base sm:text-md md:text-lg">
                            <div className="followers-details flex flex-col">
                                <span className="followers rounded-lg text-center px-2 sm:px-4 sm:py-1 border-2 text-gray-400 border-gray-400 hover:bg-gray-400 hover:text-white duration-300 cursor-pointer">{userProfile.followers}</span>
                                <span className="followers-text text-center text-gray-400 text-sm sm:text-base font-medium">Followers</span>
                            </div>
                            <div className="following-details flex flex-col">
                                <span className="following rounded-lg text-center px-2 sm:px-4 sm:py-1 border-2 text-gray-400 border-gray-400 hover:bg-gray-400 hover:text-white duration-300 cursor-pointer">{userProfile.following}</span>
                                <span className="following-text text-center text-gray-400 text-sm sm:text-base font-medium">Following</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="photo-details flex flex-col gap-2 w-fit">
                    ...
                    <div className="reactions flex flex-col sm:flex-row flex-wrap p-1 gap-8 text-xs font-semibold">
                        ...
                        <span className="flex gap-2"><i className="fa-regular fa-eye flex justify-center items-center p-1 bg-gray-600 text-white text-sm w-6 h-6 rounded-full"></i><span className="py-0.5 text-sm font-semibold">{userProfile.views}</span></span>
                        <span className="flex gap-2"><i className="fa-regular fa-heart flex justify-center items-center p-1 bg-red-600 text-white text-sm w-6 h-6 rounded-full"></i><span className="py-0.5 text-sm font-semibold">{userProfile.heartLikes}</span></span>
                    </div>
                </div>
            </div>
        </div>
